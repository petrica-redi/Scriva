          ...
          <div className="rounded-2xl bg-white p-8 shadow-xl">
            ...
            <div className="space-y-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm text-slate-700">
                Click the link in your email to confirm your account. You&apos;ll then be able to sign in and start using MindCare AI.
              </p>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-2 flex items-center gap-2 text-xs text-slate-600">
                <svg className={`h-4 w-4 ${password.length >= 12 ? "text-green-600" : "text-slate-400"}`} fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              type="submit"
              disabled={loading || !fullName || !email || !specialty || password.length < 12}
