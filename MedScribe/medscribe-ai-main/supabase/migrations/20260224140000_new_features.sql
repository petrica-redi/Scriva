...
('After Your Surgery', 'General post-operative care instructions: Keep the surgical site clean and dry. Watch for signs of infection (increasing redness, swelling, warmth, pus, fever above 38.5C). Take pain medications as prescribed. Gradually increase activity as tolerated. Do not lift heavy objects for the recommended period. Attend all follow-up appointments. Contact your surgeon immediately if you experience severe pain, heavy bleeding, or signs of infection.', 'surgical', ARRAY[], 'en'),
